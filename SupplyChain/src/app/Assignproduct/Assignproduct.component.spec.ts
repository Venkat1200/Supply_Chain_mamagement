...
describe('AssignproductComponent', () => {
  ...
  let mockAssignproductService;
  let mockDataService

  beforeEach(async(() => {

    mockAssignproductService = sinon.createStubInstance(AssignproductService);
    mockAssignproductService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AssignproductService, useValue: mockAssignproductService },
