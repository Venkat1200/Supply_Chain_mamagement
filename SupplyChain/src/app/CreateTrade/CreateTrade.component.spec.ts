...
describe('CreateTradeComponent', () => {
  ...
  let mockCreateTradeService;
  let mockDataService

  beforeEach(async(() => {

    mockCreateTradeService = sinon.createStubInstance(CreateTradeService);
    mockCreateTradeService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: CreateTradeService, useValue: mockCreateTradeService },
